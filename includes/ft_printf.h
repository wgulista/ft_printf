...
int					conv_s(const char *str, int *i, va_list *arg);
int					conv_S(const char *str, int *i, va_list *arg);
int					conv_p(const char *str, int *i, va_list *arg);
int					(*p[14])(const char *str, int *i, va_list *arg);	
int					check_flags(int c);

void				init_pointer();
void				init_var(t_count *cp);
void				init_env(t_env *env, va_list *arg, int *i, const char *str);

void				find_n(t_env *env, int end, const char *str);
int					update_int(const char *str, int *i, va_list *arg, int p_o);
...
void				found_function(t_count *cp, const char *str, va_list *arg);
